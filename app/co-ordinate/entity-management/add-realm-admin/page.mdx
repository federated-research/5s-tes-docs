...
<Callout type="info">
  ...
  - This user does **not**
  need full Realm Administrator privileges. 
  - The roles above provide the
  minimum permissions required by the Submission API to create clients, enable
  service accounts, and assign roles to those service accounts.
</Callout>
