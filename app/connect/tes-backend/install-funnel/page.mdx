...
<Tabs items={['Install Script', 'Build from Source', 'Homebrew', 'Manual Binary Install']}>
 <Tabs.Tab>
...
<Tabs.Tab>
  Instructions on how to build Funnel from source can be found
  [here](https://calypr.org/tools/funnel/docs/development/developers/)
</Tabs.Tab>
