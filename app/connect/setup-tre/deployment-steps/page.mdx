...
<Table>
  ...
  <tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>
        The public URL for the TRE Agent API. For example, https://my-TRE-host.net.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`TRES3ConsoleUrl`</Table.Td>
      <Table.Td>
        Where the S3 TRE UI is hosted. For example, https://s3-tre-ui.net.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`TreKeyCloakClientUIRedirectURL`</Table.Td>
      <Table.Td>
        The URL for the TRE UI's Keycloak redirect URL. For example, https://host-of-tre.net/.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`EgressKeyCloakClientUIRedirectURL`</Table.Td>
      <Table.Td>
        The URL for the Egress Layer's Keycloak redirect URL. For example, https://host-of-egress.net/.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`KeycloakFullURL`</Table.Td>
