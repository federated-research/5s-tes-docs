...
- Is the project you are assigned to approved by the TRE and online? If not, the submission will be failed. An TRE administrator will have to [approve the project](/guides/manage-tre/approvals) and make sure the sync and scan process is working.
