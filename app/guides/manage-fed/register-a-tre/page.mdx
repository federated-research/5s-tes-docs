...
- A TRE admin user - Submission Layer's Keycloak Admin has to create a new user in Keycloak with the `dare-tre-admin` role using this [guide](/guides/manage-fed/add-keycloak-user). The credentials of this user will be used by TRE Operator to connect their TRE to the Submission Layer.
...
- [Assign TRE to a Project](/guides/manage-fed/assign-tre-user-to-project)
