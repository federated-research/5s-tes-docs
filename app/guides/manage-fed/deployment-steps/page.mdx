...
<Table>
  ...
  <tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>
        Where the S3 Submission Layer API is hosted. For example, https://s3-submission-api.example.com. This is required by TRE Agent or external services to connect to the Submission Layer S3 server.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
