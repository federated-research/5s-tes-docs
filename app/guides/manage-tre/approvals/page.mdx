...
- Understand how the TRE Agent synchronises with the Submission Layer. [See Synchronisation](/guides/manage-tre/connect-submission#synchronisation)
...
- A connected TRE Agent. See [Connect a TRE Agent to the Submission Layer](/guides/manage-tre/connect-submission).
...
- [Controlling TRE data access](/guides/manage-tre/control-tre-data-access).
- [Review and approve outputs](/guides/egress-approval/approve-outputs).
