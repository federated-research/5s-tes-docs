...
- A deployed TRE Layer. Deployment steps can be found [here](/guides/manage-tre/deployment-steps).
...
- [Set up TRE data access](/guides/manage-tre/control-tre-data-access)
