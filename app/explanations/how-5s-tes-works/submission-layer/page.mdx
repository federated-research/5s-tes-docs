...
| **S3 API**         | So that TREs can put the analytics results into S3 storage and [Workbench](/tutorials/submit-to-5s-tes/workbench) can get results from S3 storage through a REST API | 9000           |
